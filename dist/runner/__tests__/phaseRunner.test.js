...
import { runPhases, runSinglePhase, dryRunReport, promptForContinuation, parseSpecSections, buildPhaseContext, } from "../phaseRunner.js";
...
describe("phaseRunner", () => {
    ...
    describe("buildPhaseContext — spec embedding", () => {
        ...
        it("omits Spec Content block when no tasks reference sections", () => {
            ...
            const context = buildPhaseContext(tasksJson.phases[0], state, "", tasksJson, specPath);
        ...
        it("handles missing spec file gracefully", () => {
            ...
            const context = buildPhaseContext(tasksJson.phases[0], state, "", tasksJson, join(specDir, "nonexistent.md"));
