...
describe.skipIf(!playwrightAvailable)("runBrowserSmoke (integration)", () => {
    ...
    it("detects a blank page", async () => {
        ...
        expect(report.interactionFailures).toEqual(expect.arrayContaining([expect.stringContaining("blank")]));
    });
    ...
    it("passes when page has app root but no text", async () => {
        ...
        expect(report.interactionFailures).not.toEqual(expect.arrayContaining([expect.stringContaining("blank")]));
    });
    ...
    it("returns navigation failure for an unreachable URL", async () => {
        ...
        expect(report.skipped).toBe(false);
        expect(report.passed).toBe(false);
        expect(report.consoleErrors).toEqual(expect.arrayContaining([expect.stringContaining("Navigation failed")]));
    });
});
//# sourceMappingURL=browserSmoke.test.js.map