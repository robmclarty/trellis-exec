...
const modelSchema = z
    .string()
    .refine((v) => MODEL_ALIASES.includes(v) ||
    MODEL_ID_PATTERN.test(v), { message: "Must be a model alias (sonnet, opus, haiku, inherit) or a full model ID (e.g. claude-opus-4-6)" });
/**
 ...
 */
export function parseAgentFrontmatter(markdown) {
...
//# sourceMappingURL=agentLint.js.map